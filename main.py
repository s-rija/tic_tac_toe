...
def button(frame):          #Function to define a button
    b=Button(frame,padx=2,bg="floralwhite",width=4,text="   ",font=('Playfair Display',60),relief="ridge",bd=1)
    return b
...
colour={'O':"mediumaquamarine",'X':"darkslategray"}
b=[[],[],[]]
for i in range(3):
        for j in range(3):
...
label=Label(text=a+"'s Chance",font=('Playfair Display',20,))
